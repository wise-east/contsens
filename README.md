...
- 🎯 Entry points to execute your program using `python -m <csci699_dcnlp_projectcode>` or `$ csci699_dcnlp_projectcode` with basic CLI argument parsing.
...
Awesome csci699_dcnlp_projectcode created by wise-east

## Install it from PyPI

```bash
pip install csci699_dcnlp_projectcode
```

## Usage

```py
from csci699_dcnlp_projectcode import BaseClass
from csci699_dcnlp_projectcode import base_function
...
```bash
$ python -m csci699_dcnlp_projectcode
#or
$ csci699_dcnlp_projectcode
```
